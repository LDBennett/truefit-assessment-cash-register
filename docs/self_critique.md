...
The primary algorithmic limitation in `calculateGreedyChange` is that the **greedy coin change algorithm is only provably optimal for _canonical coin systems_**.
